...
Load when: Use this for SaaS dashboards, KPI hierarchy, filters, charts, tables, empty states, permissions, and responsive operational layouts.

## Staff-Level Intent

Treat dashboards as a product quality system, not a cosmetic checklist.
...
- A dashboard should reveal status, change, risk, and next action.
- Put the most decision-critical KPIs first.
- Use filters that match real user questions.
- Keep charts and tables connected by shared time ranges and filters.
- Design permission-aware empty and restricted states.
- Use density appropriate for repeated daily use.
- Make drill-down paths obvious.
- Avoid equal-weight widget grids with no editorial judgment.
- Use responsive layouts that preserve task order.
- Operational dashboards should feel calm, fast, and trustworthy.

## Implementation Heuristics

- Heuristic 1: A dashboard should reveal status, change, risk, and next action. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 2: Put the most decision-critical KPIs first. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 3: Use filters that match real user questions. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 4: Keep charts and tables connected by shared time ranges and filters. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 5: Design permission-aware empty and restricted states. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 6: Use density appropriate for repeated daily use. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 7: Make drill-down paths obvious. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 8: Avoid equal-weight widget grids with no editorial judgment. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 9: Use responsive layouts that preserve task order. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 10: Operational dashboards should feel calm, fast, and trustworthy. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 11: A dashboard should reveal status, change, risk, and next action. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 12: Put the most decision-critical KPIs first. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 13: Use filters that match real user questions. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 14: Keep charts and tables connected by shared time ranges and filters. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 15: Design permission-aware empty and restricted states. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 16: Use density appropriate for repeated daily use. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 17: Make drill-down paths obvious. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
