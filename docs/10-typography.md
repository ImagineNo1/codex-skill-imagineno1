...
Load when: Use this for type scales, font loading, hierarchy, Persian typography, line length, rhythm, and readability.

## Staff-Level Intent

Treat typography as a product quality system, not a cosmetic checklist.
...
- Typography is hierarchy before style.
- Use a limited scale with clear roles: display, title, heading, body, label, caption.
- Keep line length readable: narrower for prose, wider for dense data.
- Use font weights sparingly; weight inflation makes everything loud.
- Set line-height by content type, not globally by habit.
- Persian UI needs a font built for Persian shaping and readability.
- Avoid negative letter spacing, especially in Persian.
- Use tabular numbers for metrics and aligned numeric tables when available.
- Font loading must not cause layout jumps.
- Labels should be compact but never cryptic.

## Implementation Heuristics

- Heuristic 1: Typography is hierarchy before style. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 2: Use a limited scale with clear roles: display, title, heading, body, label, caption. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 3: Keep line length readable: narrower for prose, wider for dense data. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 4: Use font weights sparingly; weight inflation makes everything loud. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 5: Set line-height by content type, not globally by habit. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 6: Persian UI needs a font built for Persian shaping and readability. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 7: Avoid negative letter spacing, especially in Persian. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 8: Use tabular numbers for metrics and aligned numeric tables when available. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 9: Font loading must not cause layout jumps. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 10: Labels should be compact but never cryptic. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 11: Typography is hierarchy before style. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 12: Use a limited scale with clear roles: display, title, heading, body, label, caption. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 13: Keep line length readable: narrower for prose, wider for dense data. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 14: Use font weights sparingly; weight inflation makes everything loud. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 15: Set line-height by content type, not globally by habit. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 16: Persian UI needs a font built for Persian shaping and readability. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 17: Avoid negative letter spacing, especially in Persian. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
