...
Load when: Use this for admin IA, settings pages, CRUD, audit trails, permissions, tabs, preview workflows, and management interfaces.

## Staff-Level Intent

Treat admin panels as a product quality system, not a cosmetic checklist.
...
- Admin panels prioritize control, clarity, and recoverability.
- Settings should be grouped by mental model, not database tables.
- Tabs must show only the active panel unless comparison is intentional.
- Preview changes before save when output affects public pages.
- CRUD flows need clear create, edit, delete, restore, and cancel paths.
- Dangerous actions require friction proportional to impact.
- Audit trails should expose who changed what and when.
- Permission states must be explicit and non-leaky.
- Bulk actions need selection clarity and confirmation.
- Admin UI should be dense but never mysterious.

## Implementation Heuristics

- Heuristic 1: Admin panels prioritize control, clarity, and recoverability. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 2: Settings should be grouped by mental model, not database tables. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 3: Tabs must show only the active panel unless comparison is intentional. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 4: Preview changes before save when output affects public pages. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 5: CRUD flows need clear create, edit, delete, restore, and cancel paths. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 6: Dangerous actions require friction proportional to impact. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 7: Audit trails should expose who changed what and when. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 8: Permission states must be explicit and non-leaky. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 9: Bulk actions need selection clarity and confirmation. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 10: Admin UI should be dense but never mysterious. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 11: Admin panels prioritize control, clarity, and recoverability. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 12: Settings should be grouped by mental model, not database tables. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 13: Tabs must show only the active panel unless comparison is intentional. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 14: Preview changes before save when output affects public pages. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 15: CRUD flows need clear create, edit, delete, restore, and cancel paths. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 16: Dangerous actions require friction proportional to impact. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 17: Audit trails should expose who changed what and when. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
