...
Load when: Use this for visual direction, UX polish, premium product feel, hierarchy, density, and interaction judgment.

## Staff-Level Intent

Treat ui principles as a product quality system, not a cosmetic checklist.
...
- Borrow principles, not costumes, from excellent products.
- Make the primary action obvious within three seconds.
- Use calm surfaces for operational interfaces and richer imagery for landing pages.
- Every section needs a job: inform, compare, decide, act, or reassure.
- Visual hierarchy starts with content priority, then type, spacing, color, and placement.
- Good UI feels inevitable: fewer choices, clearer grouping, better defaults.
- Use icons to clarify actions, not decorate paragraphs.
- Make scanning paths predictable: title, metric, context, action.
- Avoid nested cards; use full-width bands or clear sections.
- Polish alignment before adding ornament.

## Implementation Heuristics

- Heuristic 1: Borrow principles, not costumes, from excellent products. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 2: Make the primary action obvious within three seconds. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 3: Use calm surfaces for operational interfaces and richer imagery for landing pages. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 4: Every section needs a job: inform, compare, decide, act, or reassure. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 5: Visual hierarchy starts with content priority, then type, spacing, color, and placement. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 6: Good UI feels inevitable: fewer choices, clearer grouping, better defaults. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 7: Use icons to clarify actions, not decorate paragraphs. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 8: Make scanning paths predictable: title, metric, context, action. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 9: Avoid nested cards; use full-width bands or clear sections. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 10: Polish alignment before adding ornament. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 11: Borrow principles, not costumes, from excellent products. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 12: Make the primary action obvious within three seconds. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 13: Use calm surfaces for operational interfaces and richer imagery for landing pages. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 14: Every section needs a job: inform, compare, decide, act, or reassure. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 15: Visual hierarchy starts with content priority, then type, spacing, color, and placement. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 16: Good UI feels inevitable: fewer choices, clearer grouping, better defaults. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 17: Use icons to clarify actions, not decorate paragraphs. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
