...
Load when: Use this for grids, responsive structure, shells, navbars, sidebars, panels, full-width pages, and viewport behavior.

## Staff-Level Intent

Treat layout as a product quality system, not a cosmetic checklist.
...
- Start with the shell: nav, content, actions, secondary panels.
- Use full-width bands for pages and constrained inner content for readability.
- Do not trap product tools inside decorative cards.
- Define stable dimensions for boards, tables, tiles, charts, and toolbars.
- Use CSS grid for two-dimensional structure and flex for one-dimensional flow.
- Design mobile as a workflow, not a squeezed desktop.
- Sidebars need clear selected state, collapse behavior, and keyboard focus.
- Sticky headers must not obscure content or focus targets.
- Responsive breakpoints should reflect content stress, not device folklore.
- Keep primary actions in predictable locations.

## Implementation Heuristics

- Heuristic 1: Start with the shell: nav, content, actions, secondary panels. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 2: Use full-width bands for pages and constrained inner content for readability. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 3: Do not trap product tools inside decorative cards. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 4: Define stable dimensions for boards, tables, tiles, charts, and toolbars. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 5: Use CSS grid for two-dimensional structure and flex for one-dimensional flow. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 6: Design mobile as a workflow, not a squeezed desktop. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 7: Sidebars need clear selected state, collapse behavior, and keyboard focus. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 8: Sticky headers must not obscure content or focus targets. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 9: Responsive breakpoints should reflect content stress, not device folklore. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 10: Keep primary actions in predictable locations. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 11: Start with the shell: nav, content, actions, secondary panels. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 12: Use full-width bands for pages and constrained inner content for readability. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 13: Do not trap product tools inside decorative cards. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 14: Define stable dimensions for boards, tables, tiles, charts, and toolbars. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 15: Use CSS grid for two-dimensional structure and flex for one-dimensional flow. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 16: Design mobile as a workflow, not a squeezed desktop. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 17: Sidebars need clear selected state, collapse behavior, and keyboard focus. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
