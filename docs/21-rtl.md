...
Load when: Use this for RTL layout, logical properties, icon mirroring, sidebars, dropdowns, tables, forms, modals, and direction-safe CSS.

## Staff-Level Intent

Treat rtl as a product quality system, not a cosmetic checklist.
...
- Inspect the current RTL strategy before editing.
- Prefer logical properties and utilities over left/right when possible.
- Set `dir` at the highest correct boundary.
- Mirror directional icons only when their meaning is spatial.
- Do not mirror brand icons or semantic symbols that should stay fixed.
- Check menus, popovers, sheets, drawers, and sidebars for placement.
- Tables need direction-aware alignment and action placement.
- Forms need correct label, helper, error, and icon positioning.
- Mixed LTR content like emails, URLs, and code needs isolation.
- Test keyboard navigation in visual order and DOM order.

## Implementation Heuristics

- Heuristic 1: Inspect the current RTL strategy before editing. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 2: Prefer logical properties and utilities over left/right when possible. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 3: Set `dir` at the highest correct boundary. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 4: Mirror directional icons only when their meaning is spatial. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 5: Do not mirror brand icons or semantic symbols that should stay fixed. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 6: Check menus, popovers, sheets, drawers, and sidebars for placement. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 7: Tables need direction-aware alignment and action placement. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 8: Forms need correct label, helper, error, and icon positioning. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 9: Mixed LTR content like emails, URLs, and code needs isolation. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 10: Test keyboard navigation in visual order and DOM order. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 11: Inspect the current RTL strategy before editing. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 12: Prefer logical properties and utilities over left/right when possible. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 13: Set `dir` at the highest correct boundary. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 14: Mirror directional icons only when their meaning is spatial. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 15: Do not mirror brand icons or semantic symbols that should stay fixed. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 16: Check menus, popovers, sheets, drawers, and sidebars for placement. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 17: Tables need direction-aware alignment and action placement. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
