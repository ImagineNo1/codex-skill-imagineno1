...
Load when: Use this for animation philosophy, timing, easing, interaction feedback, page transitions, and micro-interactions.

## Staff-Level Intent

Treat motion as a product quality system, not a cosmetic checklist.
...
- Motion must explain state, continuity, or feedback.
- Keep durations short for UI: fast enough to feel responsive.
- Use easing that starts and ends naturally; avoid mechanical linear motion.
- Animate opacity and transform before layout properties.
- Do not animate large surfaces during critical task entry.
- Respect reduced motion.
- Use micro-interactions for confirmation, affordance, and orientation.
- Avoid animation stacking where multiple regions compete.
- Use spring motion only when physical response helps comprehension.
- Motion should disappear from attention after the first use.

## Implementation Heuristics

- Heuristic 1: Motion must explain state, continuity, or feedback. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 2: Keep durations short for UI: fast enough to feel responsive. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 3: Use easing that starts and ends naturally; avoid mechanical linear motion. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 4: Animate opacity and transform before layout properties. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 5: Do not animate large surfaces during critical task entry. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 6: Respect reduced motion. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 7: Use micro-interactions for confirmation, affordance, and orientation. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 8: Avoid animation stacking where multiple regions compete. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 9: Use spring motion only when physical response helps comprehension. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 10: Motion should disappear from attention after the first use. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 11: Motion must explain state, continuity, or feedback. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 12: Keep durations short for UI: fast enough to feel responsive. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 13: Use easing that starts and ends naturally; avoid mechanical linear motion. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 14: Animate opacity and transform before layout properties. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 15: Do not animate large surfaces during critical task entry. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 16: Respect reduced motion. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 17: Use micro-interactions for confirmation, affordance, and orientation. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
