...
Load when: Use this for Persian UX, typography, copy, Jalali dates, Toman/Rial formatting, Persian numerals, and culturally natural interfaces.

## Staff-Level Intent

Treat persian ui as a product quality system, not a cosmetic checklist.
...
- Use Persian typography that is legible at UI sizes.
- Keep Persian copy concise, respectful, and action-oriented.
- Use Jalali dates when the product context expects Persian calendar UX.
- Format currency consistently as Toman or Rial; do not mix casually.
- Use Persian numerals only when the project already does or the user requests it.
- Handle mixed English terms deliberately with direction isolation.
- Avoid literal translations of SaaS terms when a natural Persian term exists.
- Buttons should use verbs users recognize.
- Error messages should explain recovery, not blame the user.
- Legal, finance, and admin Persian UI should lean formal and precise.

## Implementation Heuristics

- Heuristic 1: Use Persian typography that is legible at UI sizes. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 2: Keep Persian copy concise, respectful, and action-oriented. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 3: Use Jalali dates when the product context expects Persian calendar UX. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 4: Format currency consistently as Toman or Rial; do not mix casually. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 5: Use Persian numerals only when the project already does or the user requests it. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 6: Handle mixed English terms deliberately with direction isolation. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 7: Avoid literal translations of SaaS terms when a natural Persian term exists. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 8: Buttons should use verbs users recognize. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 9: Error messages should explain recovery, not blame the user. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 10: Legal, finance, and admin Persian UI should lean formal and precise. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 11: Use Persian typography that is legible at UI sizes. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 12: Keep Persian copy concise, respectful, and action-oriented. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 13: Use Jalali dates when the product context expects Persian calendar UX. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 14: Format currency consistently as Toman or Rial; do not mix casually. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 15: Use Persian numerals only when the project already does or the user requests it. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 16: Handle mixed English terms deliberately with direction isolation. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 17: Avoid literal translations of SaaS terms when a natural Persian term exists. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
