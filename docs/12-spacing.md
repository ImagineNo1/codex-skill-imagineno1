...
Load when: Use this for 8px rhythm, density, padding, gaps, alignment, grouping, and responsive spacing.

## Staff-Level Intent

Treat spacing as a product quality system, not a cosmetic checklist.
...
- Use an 8px rhythm as the default spacing backbone.
- Use 4px only for tight internal relationships.
- Increase spacing to separate concepts, not to decorate.
- Keep repeated items aligned on the same spacing system.
- Dense dashboards still need breathing room around groups.
- Mobile spacing should reduce width pressure without making targets tiny.
- Use gap over margins inside flex and grid groups when possible.
- Use padding to define component comfort and gap to define relationships.
- Avoid arbitrary spacing unless matching a real asset or layout constraint.
- Spacing should make the information architecture visible.

## Implementation Heuristics

- Heuristic 1: Use an 8px rhythm as the default spacing backbone. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 2: Use 4px only for tight internal relationships. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 3: Increase spacing to separate concepts, not to decorate. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 4: Keep repeated items aligned on the same spacing system. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 5: Dense dashboards still need breathing room around groups. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 6: Mobile spacing should reduce width pressure without making targets tiny. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 7: Use gap over margins inside flex and grid groups when possible. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 8: Use padding to define component comfort and gap to define relationships. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 9: Avoid arbitrary spacing unless matching a real asset or layout constraint. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 10: Spacing should make the information architecture visible. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 11: Use an 8px rhythm as the default spacing backbone. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 12: Use 4px only for tight internal relationships. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 13: Increase spacing to separate concepts, not to decorate. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 14: Keep repeated items aligned on the same spacing system. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 15: Dense dashboards still need breathing room around groups. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 16: Mobile spacing should reduce width pressure without making targets tiny. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 17: Use gap over margins inside flex and grid groups when possible. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
