...
Load when: Use this for WCAG AA, keyboard navigation, ARIA, focus management, reduced motion, and screen reader support.

## Staff-Level Intent

Treat accessibility as a product quality system, not a cosmetic checklist.
...
- Target WCAG AA for contrast and interaction by default.
- Every interactive element must be keyboard reachable and visibly focusable.
- Use native elements before ARIA.
- ARIA should clarify semantics, not repair bad structure.
- Dialogs, popovers, menus, and sheets need correct focus management.
- Labels must be programmatically associated with inputs.
- Errors must be discoverable by screen readers and visible users.
- Respect reduced motion preferences.
- Never rely on color alone for status.
- Test tab order mentally and in browser when possible.

## Implementation Heuristics

- Heuristic 1: Target WCAG AA for contrast and interaction by default. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 2: Every interactive element must be keyboard reachable and visibly focusable. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 3: Use native elements before ARIA. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 4: ARIA should clarify semantics, not repair bad structure. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 5: Dialogs, popovers, menus, and sheets need correct focus management. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 6: Labels must be programmatically associated with inputs. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 7: Errors must be discoverable by screen readers and visible users. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 8: Respect reduced motion preferences. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 9: Never rely on color alone for status. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 10: Test tab order mentally and in browser when possible. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 11: Target WCAG AA for contrast and interaction by default. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 12: Every interactive element must be keyboard reachable and visibly focusable. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 13: Use native elements before ARIA. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 14: ARIA should clarify semantics, not repair bad structure. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 15: Dialogs, popovers, menus, and sheets need correct focus management. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 16: Labels must be programmatically associated with inputs. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 17: Errors must be discoverable by screen readers and visible users. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
