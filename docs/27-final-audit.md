...
Load when: Use this before final response after any UI implementation, redesign, review, or frontend architecture change.

## Staff-Level Intent

Treat final audit as a product quality system, not a cosmetic checklist.
...
- Verify validation commands were run or explain why not.
- Verify no unrelated user changes were reverted.
- Verify final response is concise and useful.
- Report remaining risks without dramatizing them.
- Suggest follow-up only when it directly builds on the task.

## Implementation Heuristics

- Heuristic 1: Verify changed files match the user request. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 2: Verify visual hierarchy and spacing are intentional. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 3: Verify accessibility states and keyboard paths. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 4: Verify responsive behavior for mobile and desktop. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 5: Verify RTL behavior for Persian interfaces. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 6: Verify validation commands were run or explain why not. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 7: Verify no unrelated user changes were reverted. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 8: Verify final response is concise and useful. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 9: Report remaining risks without dramatizing them. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 10: Suggest follow-up only when it directly builds on the task. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 11: Verify changed files match the user request. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 12: Verify visual hierarchy and spacing are intentional. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 13: Verify accessibility states and keyboard paths. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 14: Verify responsive behavior for mobile and desktop. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 15: Verify RTL behavior for Persian interfaces. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 16: Verify validation commands were run or explain why not. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 17: Verify no unrelated user changes were reverted. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
