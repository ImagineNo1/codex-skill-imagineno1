...
Load when: Use this for forms, validation, React Hook Form, Zod, labels, help text, errors, disabled states, and RTL-safe input UX.

## Staff-Level Intent

Treat forms as a product quality system, not a cosmetic checklist.
...
- Every field needs a label unless an accessible alternative is explicit.
- Use help text before users fail, not only after validation.
- Validation should be specific, close to the field, and respectful.
...
- Use React Hook Form and Zod when the project already uses them or complexity warrants it.
- In RTL forms, verify label alignment, input direction, icons, and numeric fields.
- Do not make optional fields look required.

## Implementation Heuristics

- Heuristic 1: Every field needs a label unless an accessible alternative is explicit. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 2: Use help text before users fail, not only after validation. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 3: Validation should be specific, close to the field, and respectful. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 4: Disable submit during async work and show progress. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 5: Preserve entered data on errors. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 6: Use correct input types and autocomplete attributes. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 7: Group related fields visually and semantically. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 8: Use React Hook Form and Zod when the project already uses them or complexity warrants it. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 9: In RTL forms, verify label alignment, input direction, icons, and numeric fields. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 10: Do not make optional fields look required. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 11: Every field needs a label unless an accessible alternative is explicit. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 12: Use help text before users fail, not only after validation. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 13: Validation should be specific, close to the field, and respectful. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 14: Disable submit during async work and show progress. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 15: Preserve entered data on errors. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 16: Use correct input types and autocomplete attributes. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 17: Group related fields visually and semantically. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
