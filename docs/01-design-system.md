...
Load when: Use this when creating, auditing, or extending tokens, shared components, visual language, dark mode, or brand consistency.

## Staff-Level Intent

Treat design system as a product quality system, not a cosmetic checklist.
...
- Map tokens before touching surfaces.
- Define spacing, radius, type, color, border, elevation, and motion as shared decisions.
- Use semantic colors for intent: background, foreground, muted, border, accent, success, warning, destructive, info.
- Use component-level tokens only when global tokens are too broad.
- Dark mode must preserve contrast and hierarchy, not simply invert colors.
- Elevation should be rare; prefer borders and layering for SaaS UI.
- Radius scale must be consistent across buttons, inputs, cards, dialogs, and menus.
- Document any new visual primitive through code, not prose only.
- Avoid one-off hex colors unless creating a token migration step.
- Keep tokens stable enough that future pages can reuse them.

## Implementation Heuristics

- Heuristic 1: Map tokens before touching surfaces. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 2: Define spacing, radius, type, color, border, elevation, and motion as shared decisions. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 3: Use semantic colors for intent: background, foreground, muted, border, accent, success, warning, destructive, info. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 4: Use component-level tokens only when global tokens are too broad. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 5: Dark mode must preserve contrast and hierarchy, not simply invert colors. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 6: Elevation should be rare; prefer borders and layering for SaaS UI. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 7: Radius scale must be consistent across buttons, inputs, cards, dialogs, and menus. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 8: Document any new visual primitive through code, not prose only. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 9: Avoid one-off hex colors unless creating a token migration step. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 10: Keep tokens stable enough that future pages can reuse them. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 11: Map tokens before touching surfaces. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 12: Define spacing, radius, type, color, border, elevation, and motion as shared decisions. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 13: Use semantic colors for intent: background, foreground, muted, border, accent, success, warning, destructive, info. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 14: Use component-level tokens only when global tokens are too broad. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 15: Dark mode must preserve contrast and hierarchy, not simply invert colors. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 16: Elevation should be rare; prefer borders and layering for SaaS UI. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 17: Radius scale must be consistent across buttons, inputs, cards, dialogs, and menus. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
