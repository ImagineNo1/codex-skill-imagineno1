...
Load when: Use this for heroes, CTAs, pricing, testimonials, FAQ, trust, conversion, storytelling, and responsive marketing pages.

## Staff-Level Intent

Treat landing pages as a product quality system, not a cosmetic checklist.
...
- The first viewport must communicate the offer, audience, and next action.
- Use a strong hero with a concrete value proposition.
- Primary CTA should be visible, specific, and repeated at natural decision points.
- Secondary CTA should reduce risk or enable exploration.
- Trust signals need context, not logo wallpaper.
- Feature sections should connect capability to outcome.
- Pricing should reduce confusion and comparison effort.
- Testimonials should be specific enough to be credible.
- FAQ should answer buying objections, not filler questions.
- Final CTA should feel like the natural conclusion, not a banner pasted at the end.

## Implementation Heuristics

- Heuristic 1: The first viewport must communicate the offer, audience, and next action. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 2: Use a strong hero with a concrete value proposition. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 3: Primary CTA should be visible, specific, and repeated at natural decision points. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 4: Secondary CTA should reduce risk or enable exploration. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 5: Trust signals need context, not logo wallpaper. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 6: Feature sections should connect capability to outcome. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 7: Pricing should reduce confusion and comparison effort. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 8: Testimonials should be specific enough to be credible. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 9: FAQ should answer buying objections, not filler questions. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 10: Final CTA should feel like the natural conclusion, not a banner pasted at the end. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 11: The first viewport must communicate the offer, audience, and next action. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 12: Use a strong hero with a concrete value proposition. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 13: Primary CTA should be visible, specific, and repeated at natural decision points. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 14: Secondary CTA should reduce risk or enable exploration. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 15: Trust signals need context, not logo wallpaper. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 16: Feature sections should connect capability to outcome. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
- Heuristic 17: Pricing should reduce confusion and comparison effort. Apply it through existing components, tokens, routes, and state boundaries before adding new abstractions.
